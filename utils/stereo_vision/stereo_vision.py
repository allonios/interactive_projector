...
with mp_facedetector.FaceDetection(
    ...
    while cap_right.isOpened() and cap_left.isOpened():
        ...
        frame_right, frame_left = calibration.undistorted_rectify(
        ...
        if not succes_right or not succes_left:
            ...
            if not results_right.detections or not results_left.detections:
                ...
                # Function to calculate depth of object. Outputs vector of all
                # depths in case of several balls.
                ...
                # Multiply computer value with 205.8 to get real-life
                # depth in [cm]. The factor was found manually.
